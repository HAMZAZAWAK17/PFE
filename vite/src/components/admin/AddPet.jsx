      ...
      {userDetails && admin === 1 ? (
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="sexe" className="block font-bold text-gray-700">
                Sexe:
              </label>
              <select
                id="sexe"
            ...
            <div>
              <label htmlFor="espece" className="block font-bold text-gray-700">
                Espèce:
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="sante" className="block font-bold text-gray-700">
                Santé:
              </label>
              <input
                type="text"
